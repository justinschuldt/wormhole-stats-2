...
import { chainColors, amountFormatter, usdFormatter, chainNameColors } from "../../../utils/explorer"
...
const DailyTVLLineChart = (props: DailyCountProps) => {
    ...
    useEffect(() => {
        ...
        const datum = sortedDays.reduce<{ [groupKey: string]: Serie }>((accum, date) => {
            ...
            return Object.keys(chains).sort((a, b) => a > b ? 1 : 0).reduce<{ [groupKey: string]: Serie }>((subAccum, chainId) => {
                ...
                let amount = chains[chainId]["*"].Notional
    ...
    return (
        <div style={{ flexGrow: 1, height: 530, width: '100%', marginBottom: 40, fontSize: 16 }}>
...
export default DailyTVLLineChart
