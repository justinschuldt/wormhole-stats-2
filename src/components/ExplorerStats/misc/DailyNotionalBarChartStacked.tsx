...
import { NotionalTransferredTo } from '../../../types/cloud-functions';

import { ResponsiveBar, BarDatum } from '@nivo/bar'

import { makeDate, chainColors, amountFormatter, usdFormatter } from "../../../utils/explorer"
...
const DailyNotionalBarChartStacked = (props: DailyCountProps) => {
    ...
    return (
        <div style={{ color: 'rgba(0, 0, 0, 0.85)', height: 400, minWidth: 400, flex: '1', marginBottom: 40 }}>
            <Typography variant="h3" style={{ marginLeft: 20 }}>value received (USD)</Typography>
...
export default DailyNotionalBarChartStacked
