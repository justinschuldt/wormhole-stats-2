...
import TVLChains from "../components/ExplorerStats/TVL/TVLChains";
...
const TVLChainsPage = ({ location }: PageProps) => {
  ...
  return (
    <Layout>
      ...
      <PageHeader headerText="Total Value Locked" subText="Notional USD value locked in Wormhole" />
