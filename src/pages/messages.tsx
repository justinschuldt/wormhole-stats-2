...
import MessagesChains from "../components/ExplorerStats/Messages/MessagesChains";
...
const MessagesPage = ({ location }: PageProps) => {
  ...
  return (
    <Layout>
      ...
      <PageHeader headerText="Wormhole Messages" subText="Amount and frequency of interactions with Wormhole" />
